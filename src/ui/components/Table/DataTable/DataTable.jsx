            ...
            {table.getHeaderGroups().map((headerGroup) => (
              <tr key={headerGroup.id}>
                {headerGroup.headers.map((header) => (
                  <th className={styles.table_header} key={header.id} style={{ width: header.getSize(), textAlign: header.column.id === "status" || header.column.id === "material" ? "center" : "left" }}>
              ...
              return (
                <tr className={styles.table_row} key={row.id}>
                  {row.getVisibleCells().map((cell) => (
                    <td className={styles.table_cell} key={cell.id} style={{ width: cell.column.getSize(), textAlign: cell.column.id === "status" || cell.column.id === "material" ? "center" : "left" }}>
